...
},
{
    ...
    option5: "",
    correctAnswer: 2,
    explanation: "It's essential that kids learn the letter SOUNDS. Letter names can help with that, but don't get stuck on them.",
    explanation2: "Teach the most common letter sounds early. Then add letter names and less common letter sound instruction later, building on the first.",
    videoUrl: "",
    videoId: "0zX7mRNcFLw",
    image: "",
    imageUrl: "",
...
},
{
    ...
    subtitle: "",
    id: 34,
    Question: "In America's prisons, the portion of inmates with significant reading deficiencies is:",
    answer_type: "mc",
    option1: "25%",
    option2: "40%",
    option3: "60%",
    ...
    option5: "",
    correctAnswer: 4,
    explanation: "Three quarters of America's prison inmates have significant reading deficiencies.",
    explanation2: "This stark statistic highlights one of the many reasons why effective reading instruction is crucial for society.",
    videoUrl: "",
    videoId: "",
    image: "",
    imageUrl: "",
    ...
    caution: "",
    citations: [{
        title: "Prevalence of dyslexia among Texas prison inmates",
        author: "K. C. Moody, et al.",
        journal: "Texas Medicine",
        volume: 96,
        number: 6,
        pages: "69-75",
        url: "https://pubmed.ncbi.nlm.nih.gov/10876375/",
        year: 2000,
    }],
    ref1: "",
    ref2: "",
...
},
{
    ...
    subtitle: "",
    id: 35,
    Question: "T/F: Black Americans are dramatically hurt by current reading instruction.",
    answer_type: "mc",
    option1: "True",
    option2: "False",
    option3: "",
    ...
    option5: "",
    correctAnswer: 1,
    explanation: "By nearly every measure, Black Americans fare worse in academics than other groups.",
    explanation2: "In 2022, Black students were half as likely to score proficient on NAEP as their White peers; 1/3 as their Asian contemporaries.",
    videoUrl: "",
    videoId: "",
    image: "",
    imageUrl: "",
    ...
    caution: "",
    citations: [{
        title: "National Achievement-Level Results for Reading -- 4th Grade",
        author: "National Center for Education Statistics",
        journal: "NAEP Data Explorer",
        volume: "",
        number: "",
        pages: "",
        url: "https://www.nationsreportcard.gov/reading/nation/achievement/?grade=4",
        year: 2022,
    }],
    ref1: "",
    ref2: "",
...
},
{
    ...
    subtitle: "",
    id: 36,
    Question: "T/F: Well off suburban white kids do fine with current approaches to reading instruction.",
    answer_type: "mc",
    option1: "True",
    option2: "False",
    option3: "",
    ...
    option5: "",
    correctAnswer: 2,
    explanation: "Although their cultural advantage lifts their language comprehension, 20-50% will have word recognition deficits and other challenges that shoud be addressed earlier.",
    explanation2: "Advantaged parents often find outside tutoring, sometimes at high cost.",
    videoUrl: "",
    videoId: "",
    image: "",
    imageUrl: "",
...
},
{
    ...
    option5: "",
    correctAnswer: 2,
    explanation: "While poverty is a good predictor of poor reading results, the evidence for overcoming it is quite strong.",
    explanation2: "Schools that implement strong literacy practices can succeed regardless of demographics.",
    resources: [{
        text: "Of 611 districts in Ohio, rated 5 stars. Steubenville is classified as 100% economically disadvantaged.",
        title: "Steubenville Schools gain overall 5-star rating",
        author: "Herald Star Staff",
        url: "https://www.heraldstaronline.com/news/local-news/2024/04/steubenville-schools-gain-overall-5-star-rating/",
        description: "A district serving an economically challenged area achieves top state ratings through systematic literacy instruction and intervention.",
        year: 2024
    },
    {
        text: "",
        title: "Is there a Reading Crisis?",
        author: "Nate Hansford",
        url: "https://www.pedagogynongrata.com/_files/ugd/237d54_50c428678e7443028da112496eb7a9b8.pdf",
        description: "",
        year: "2025"
    }],
    videoUrl: "",
    videoId: "",
    image: "images/Steubenville_2024.png",
    imageUrl: "",
    imageAltText: "",
    cautionLevel: "",
    caution: "",
    citations: [{
        ...
        author: "Michael Harwell, Yukiko Maeda, Kyoungwon Bishop & Aolin Xie",
        journal: "The Journal of Experimental Education",
        volume: "85",
        number: "2",
        pages: "197-214",
        url: "https://doi.org/10.1080/00220973.2015.1123668",
        year: 2014,
    }],
    ref1: "",
    ref2: "",
    ...
    questionP2: "It was begun under this President, but has largely been ignored:",
    answer_type: "mc",
    option1: "Lyndon Johnson",
    option2: "Jimmy Carter",
    option3: "Bill Clinton",
    option4: "George W. Bush",
    option5: "Barack Obama",
    correctAnswer: 1,
    explanation: "Project Follow Through reached 200,000 students, via 22 research & improvement teams.",
    explanation2: "They tried a vast spectrum of teaching methods, and measured learner success in multiple areas. One method produced the best results for students that were: Native American, non-white rural, urban, white and black, etc.",
    citations: [{
    ...
    closingText: "But it didn't fit the prevailing theories in colleges of education.",
    closingText2: "",
    modal: ""
},
{
    title: "",
    subtitle: "",
    id: 39,  // Increment from the last ID
    Question: "T/F: Job one for a third grade teacher is to assure all students have mastered word recognition.",
    questionP2: "",
    answer_type: "mc",
    option1: "T",
    option2: "F",
    ...
    option5: "",
    correctAnswer: 1,
    explanation: "Ideally, nearly all students would arrive in 3rd grade with mastery of phonics.",
    explanation2: "(This is not that idealistic for nearly all schools.)",
    explanation3: "In such a class, morphology can become a focus of tier-one, word-level instruction.",
    explanation4: "However 3rd grade teachers should also recognize t hat nearly all kids can read at grade lvel; and for those kids who arrive reading at ",
    videoUrl: "",
    videoId: "",
    image: "",
    imageUrl: "",
...
},
{
    ...
    subtitle: "",
    id: 42,
    Question: "T/F: A good pace for phonics instruction is about two patterns a week?",
    questionP2: "",
    answer_type: "mc",
    option1: "Yes, true",
    option2: "No, false. Should go faster.",
    option3: "No, false. Should go slower.",
    option4: "",
    option5: "",
    correctAnswer: 1,
    explanation: "While schools should adjust to the needs of their kids; in general, lessons can be completed in a coupe of days.",
    explanation2: "Lessons shold be fast and engaging, with a focus on quick responses and frequent student participation, with structured routines. Interleaved retrieval practice of previous skills provides rapid skill building.",
    videoUrl: "",
    videoId: "",
    image: "",
    imageUrl: "",
    imageAltText: "",
    cautionLevel: "",
    caution: "We'd love for you to add the research on this question.",
    citations: [{
        title: "",
        author: "",
        url: "",
    ...
    option5: "",
    correctAnswer: 2,
    explanation: "Not as ongoing as many teachers and leaders seem to think. \n\nCurrent research shows 2-9 hours of instruction being useful. Probably leaning closer to 3-6 for general classroom instruction. ",
